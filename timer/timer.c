/*
********************************************************************************
* Copyright (C), 1999 Jimi IoT Co., Ltd.
* File Name   :   work.c
* Author      :   dongxiang
* Version     :   V1.0
* Description :   Add the timer function to the work queue code.                                 
* Journal     :   2020-07-28 init v1.0 by dongxiang
* Others      :   
********************************************************************************
*/
...
static enum hrtimer_restart task1_timer_func(struct hrtimer *timer) 
{
	...
	hrtimer_start(&task1_timer, 
							ktime_set(0, 900000000), HRTIMER_MODE_REL);  // 0.9s
